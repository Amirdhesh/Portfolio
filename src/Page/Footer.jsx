...
const Footer = ({ contactref }) => {
  ...
  return (
    <div ref={footerRef} className='py-20 h-screen bg-[#6B6B6B] flex justify-around items-center'>
      ...
      <div className={`${showPopup ? 'block -100' : 'hidden -500'} absolute top-5 right-5 backdrop-blur-md backdrop-filter bg-opacity-10 border-[1px] border-black rounded-3xl shadow-2xl px-6 py-[3px]`}>        <div className="text-center">
